...
export default function SecretButton({onClick}: {onClick: any}){
    ...
    return (
        <a href="javascript:void(0)" rel="noopener noreferrer" onClick={onClick} id="secretBtn" className={`group hidden xs:block cursor-grab border backdrop-blur-2xl border-violet-500/30  dark:border-violet-500/40 bg-black/5 dark:bg-white/10 rounded-full px-1 py-1 hover:scale-105 transition-all`}>
