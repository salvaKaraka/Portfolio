    ...
    <SectionContainer className="flex justify-center mt-20 mb-14">
      ...
      <h1
			...
			<h2 className="text-xl lg:text-2xl opacity-90 max-w-[700px]">
				...
				<span className="rounded-xl bg-blue-900/70 px-2">
