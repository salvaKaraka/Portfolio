...
export default function PostCard({ title, description, link, github, model, tags, shadowPosition}: props) {
    ...
    return (
            <div className='w-full md:w-[90%] m-auto border backdrop-blur-2xl border-neutral-400 dark:border-neutral-700 p-2 rounded-xl'>
                <div className='flex flex-col md:flex-row items-center'>
                    ...
                    <div className={`lg:mr-16`}>
                        {model &&
                            <ModelCanvas height="12rem" shadowPosition={shadowPosition}>
