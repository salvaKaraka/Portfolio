...
<div id="disclaimer">
<h3>Important</h3>
<p>I've learned a lot since I started this project, and I decided to do it again from scratch, applying the lessons from my mistakes. I won't delete this post because I think it is valuable to have a record of the errors that I encountered and their solutions. This post is not up to date with the project; Now we have paralelism, links and sprins, we can also render more than 100K objects. I'will update it soon</p></div>
